...
class TodoApp(ft.Column):
    ...
    def __init__(self):
        ...
        self.filter = ft.Tabs(
            ...
            tabs=[ft.Tab(text="すべて"), ft.Tab(text="実行中"), ft.Tab(text="完了")],
        )

        # 残タスク数の表示
        self.items_left = ft.Text("0 項目が残っています")
        ...
        self.controls = [
            # ヘッダー部分
            ft.Row(
                [ft.Text(value="ToDo一覧", theme_style=ft.TextThemeStyle.HEADLINE_MEDIUM)],
                    ...
                    ft.Row(       # フッター部分
                        ...
                        controls=[
                            ...
                            ft.OutlinedButton(  # 完了タスク一括削除ボタン
                                text="完了項目を削除", on_click=self.clear_clicked
                            ),
                        ],
                    ),
                ],
